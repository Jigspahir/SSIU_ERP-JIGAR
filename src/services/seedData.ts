...
export const initialFaculty: Faculty[] = [
  {
    ...
    name: 'Prof. Vikram Trivedi',
    email: 'vikram.trivedi@swarrnim.edu.in',
    ...
    bloodGroup: 'B+',
    address: 'Swarrnim Faculty Quarters, Gandhinagar Campus',
    experienceYears: 9,
  ...
  },
  {
    ...
    email: 'sunita.patel@swarrnim.edu.in',
    ...
    bloodGroup: 'O+',
    address: 'Swarrnim Campus Quarters, Gandhinagar',
    experienceYears: 14,
  ...
  },
  {
    ...
    name: 'Prof. K. L. Verma',
    email: 'kl.verma@swarrnim.edu.in',
  ...
  },
  {
    ...
    name: 'Prof. Riddhi Shah',
    email: 'riddhi.shah@swarrnim.edu.in',
...
export const initialStudents: Student[] = [
  {
    ...
    bloodGroup: 'B+',
    address: 'Swarrnim Student Hostel Block A Room 204, Gandhinagar',
  ...
  },
  {
    ...
    name: 'Ananya Roy',
    email: 'ananya.roy@swarrnim.edu.in',
    ...
    bloodGroup: 'O+',
    address: 'Swarrnim Student Hostel Block B Room 102, Gandhinagar',
  ...
  },
  {
    ...
    name: 'Rohan Sharma',
    email: 'rohan.sharma@swarrnim.edu.in',
    phone: '+91 97234 56789',
    photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80',
    gender: 'Male',
    dateOfBirth: '2003-12-10',
    bloodGroup: 'A+',
    address: 'Swarrnim Campus Residency Block B, Gandhinagar',
  ...
  },
  {
    ...
    name: 'Diya Patel',
    email: 'diya.patel@swarrnim.edu.in',
...
export const initialUsers: User[] = [
  ...
  },
  {
    ...
    name: 'Dr. S. K. Gupta',
    username: 'principal',
    email: 'principal.sscit@swarrnim.edu.in',
    password: 'Admin@123',
    role: 'PRINCIPAL',
    instituteId: 'inst-1',
    phone: '+91 98765 43210',
  ...
  },
  {
    ...
    username: 'transport',
    email: 'transport@swarrnim.edu.in',
    password: 'Admin@123',
...
export const initialApprovalRequests: ApprovalRequest[] = [
  ...
  },
  {
    ...
    remarksHistory: [
      ...
      },
      {
        ...
        actionByUserName: 'Prof. V. K. Patel',
  ...
  },
  {
    ...
    applicantId: 'fac-1',
    applicantName: 'Prof. Vikram Trivedi',
    applicantRole: 'FACULTY',
    applicantEmail: 'vikram.trivedi@swarrnim.edu.in',
    applicantPhone: '+91 98765 22001',
    applicantEnrollmentOrEmpId: 'EMP-CSE-001',
    departmentId: 'dept-1',
    instituteId: 'inst-1',
    ...
    remarksHistory: [
      {
        ...
        actionByUserName: 'Prof. Vikram Trivedi',
      ...
      },
      {
        ...
        actionByUserName: 'Dr. N. P. Sharma',
  ...
  },
  {
    ...
    remarksHistory: [
      ...
      },
      {
        ...
        actionByUserName: 'Mr. Arvind Trivedi',
  ...
  },
  {
    ...
    applicantName: 'Dr. Amit Shah',
    applicantRole: 'HOD',
    applicantEmail: 'hod.cse@swarrnim.edu.in',
    applicantPhone: '+91 98765 11101',
    applicantEnrollmentOrEmpId: 'EMP-CSE-000',
    departmentId: 'dept-1',
    instituteId: 'inst-1',
