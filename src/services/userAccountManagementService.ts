...
export const ERP_PERMISSION_MODULES: PermissionModuleDef[] = [
  ...
  { key: 'EXAM_ELIGIBILITY', name: 'Exam Eligibility & Endorsements', category: 'Academics', description: 'Student exam eligibility register, attendance thresholds, condonations, mentor endorsements, and HOD approvals' },
  ...
  { key: 'INVENTORY_ASSETS', name: 'Inventory & Fixed Assets', category: 'Campus', description: 'Equipment registry, stock balances, custody transfers, and maintenance logs' },
  { key: 'WORKLOAD_TRANSFER', name: 'Workload & Task Transfers', category: 'Faculty', description: 'Faculty task handovers, substitute lecture delegations, and active transfer registers' },
